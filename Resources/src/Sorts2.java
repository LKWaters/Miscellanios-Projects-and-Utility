...
public class Sorts2
{
  ...
  public static void main(String[] args)
  {
    ...
    Comparator<SortCircle> SLComp = new Comparator<SortCircle>() 
    {
      public int compare(SortCircle a, SortCircle b) 
      {
    ...
    Comparator<SortCircle> RLComp = new Comparator<SortCircle>() 
    {
      public int compare(SortCircle a, SortCircle b) 
      {
    ...
    Comparator<SortCircle> HComp = new Comparator<SortCircle>() 
    {
      public int compare(SortCircle a, SortCircle b) 
      {
    	  int x =(int) (Math.sqrt(Math.pow(a.xValue,2) + Math.pow(a.yValue,2)));
    	  int y =(int) (Math.sqrt(Math.pow(b.xValue,2) + Math.pow(b.yValue,2)));
        return x-y;
      }
    };
    ...
    initValues();
    printValues();
    System.out.println("sorted from left to right:");
    selectionSort(xComp);
    printValues();
    ...
    selectionSort(SLComp);
    printValues();
    System.out.println("sorted from right to left:");
    selectionSort(RLComp);
    printValues();
    System.out.println("sorted by distance from 0,0:");
    selectionSort(HComp);
    printValues();
